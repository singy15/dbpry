...
export default {
  props: [
    "layout-id",
    "border-width",
    "size-north", "size-south", "size-east", "size-west",
    "style-north", "style-south", "style-west", "style-east", "style-center",
    "class-north", "class-south", "class-west", "class-east", "class-center",
    "resizable-north", "resizable-south", "resizable-west", "resizable-east",
    "disable-north", "disable-south", "disable-west", "disable-east",
  ],
  data() {
    return {
...
<template>
  <div :id="layoutId" style="left:0px; top:0px; right:0px; bottom:0px;position: absolute;" >
  
    <div :style="'left:0px; right:0px; top:0px; height:' + north + 'px;' 
        + 'box-sizing: border-box;position: absolute; overflow:hidden;'"
      v-if="!disableNorth" class="border border-bottom-only">
      <div :style="'width:100%;height:100%;'+styleNorth" :class="classNorth">
        <slot name="north"></slot>
      </div>
    </div>

    <div :style="'left:0px; right:0px; top:' + (north - borderWidth) + 'px; height:' + borderWidth + 'px;' 
    ...
    <div :style="'left:0px; right:0px; bottom:' + (south - borderWidth) + 'px;'
        + 'height:' + borderWidth + 'px;position: absolute;z-index: 1000;cursor:pointer;'"
      draggable="true"
    ...
    <div :style="'left:' + (west - borderWidth) + 'px; top:' + north + 'px; '
        + 'bottom:' + south + 'px; width:' + borderWidth + 'px;position: absolute;z-index: 1000;cursor:pointer;'"
      draggable="true"
    ...
    <div :style="'right:' + (east - borderWidth ) + 'px; top:' + north + 'px; bottom:' + south + 'px;'
        + 'width:' + borderWidth + 'px;position: absolute;z-index: 1000;cursor:pointer;'"
      draggable="true"
    ...
    <div :style="'left:' + west + 'px; right:' + east + 'px; top:' + north + 'px; bottom:' + south + 'px;'
        + 'box-sizing: border-box;position: absolute; overflow:hidden;'" >
...
<style scoped>
  ...
  .border-right-only { border-top: none !important; border-bottom: none !important; border-left: none !important; /*border-right: none !important;*/ }
  .border-bottom-only { border-top: none !important; /*border-bottom: none !important;*/ border-left: none !important; border-right: none !important; }
</style>
